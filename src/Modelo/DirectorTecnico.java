...
public class DirectorTecnico {
    ...
    public DirectorTecnico(int id_director_tecnico, String nombreUno, String nombreDos,
                           String apellidoUno, String apellidoDos, String cedula,
                           Date fechaNacimiento, String experiencia) {
    ...
    public DirectorTecnico(String nombreUno, String nombreDos, String apellidoUno,
                           String apellidoDos, String cedula, Date fechaNacimiento,
                           String experiencia) {
        this.nombreUno = nombreUno;
        this.nombreDos = nombreDos;
        this.apellidoUno = apellidoUno;
